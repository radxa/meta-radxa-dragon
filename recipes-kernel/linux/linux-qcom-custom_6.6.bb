...
SRC_URI = "${SRCPROJECT};branch=${SRCBRANCH};destsuffix=kernel \
           ...
           file://0001-drm-panel-Add-support-for-Orise-Tech-OTA7290B-DSI-Pa.patch \
           file://0002-drm-panel-orisetech-ota7290b-Fix-build-error.patch \
           file://0003-net-wireless-add-aic8800-usb-driver-from-vendor-AIC.patch \
           file://0004-Bluetooth-add-AIC-BT-USB-driver-from-vendor-AIC.patch \
           file://0005-drm-birdge-simple-bridge-Add-support-for-radxa-ra620.patch \
           file://0006-dt-bindings-display-simple-bridge-Add-ra620-compatib.patch \
           file://0007-WIP-phy-qcom-qmp-combo-set-default-orientation-to-re.patch \
           file://0008-BACKPORT-FROMLIST-pwm-Add-a-software-PWM-which-toggl.patch \
           file://0009-arm64-dts-qcom-Add-Radxa-AIRbox-Q900-board.patch \
           "
